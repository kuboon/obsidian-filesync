...
export class RPCClient {
    ...
    call(type: string, args: unknown[], peerId?: string, timeout = DEFAULT_TIMEOUT): Promise<unknown> {
        const seq = ++this.seq;
...
export class RPCServer {
    ...
    async dispatch(payload: Payload, sendResponse: (resp: Response) => void): Promise<void> {
